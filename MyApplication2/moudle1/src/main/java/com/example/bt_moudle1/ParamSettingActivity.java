...
public class ParamSettingActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void changeView() {
        String json = (String)SPUtils.get(this,"param_seting","");
        if (!TextUtils.isEmpty(json)){
            ParamBean paramBean = Json_U.fromJson(json,ParamBean.class);
    ...
    public void onClick(View v) {
        if (v == btnExamSave){
            ...
            SPUtils.put(ParamSettingActivity.this,"param_seting",host_url);
